...
<form method="GET" action="{{ route('employees.index') }}" class="filter-bar">
    ...
    <div>
        ...
        <select id="order_by" name="order_by">
            ...
            <option value="hire_date" @selected(request('order_by') === 'hire_date')>Hire date</option>
            <option value="salary" @selected(request('order_by') === 'salary')>Salary</option>
        </select>
    </div>
    ...
    <div>
        ...
        <select id="order_dir" name="order_dir">
            ...
            <option value="desc" @selected(request('order_dir') === 'desc')>Desc</option>
        </select>
    </div>
